...
\begin{itemize}[leftmargin=*, itemsep=1pt, topsep=1pt, parsep=1pt, partopsep=1pt]
  ...
  \item We construct WTI-82K, aligning video chunks, asynchronous queries, answerable moments, and evidence dependencies on a shared timeline for streaming interaction training under causal timing.
