...
Figure~\ref{fig:data_video_duration} reports the source-video duration distribution over the 4,812 streaming trajectories.
Following common streaming-video dataset statistics, we group trajectories into duration ranges and annotate each bar with both the number of trajectories and its percentage.

\begin{figure}[t]
  \centering
  \includegraphics[width=0.96\columnwidth]{figures/figure_video_duration_distribution.pdf}
  \caption{Video duration distribution of WTI-82K, counted over streaming trajectories.}
