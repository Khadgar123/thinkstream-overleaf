...
Figure~\ref{fig:data_video_duration} reports the source-video duration distribution over 4,812 streaming trajectories, with each bar showing the count and percentage for one duration range.
