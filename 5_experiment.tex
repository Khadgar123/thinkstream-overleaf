...
Masked SFT raises StreamingBench from 74.1\% to 75.3\% and OVO-RT from 64.7\% to 74.2\%, showing that the model learns the basic action format and recent-prefix perception.
